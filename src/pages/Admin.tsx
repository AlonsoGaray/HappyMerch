...
import { ElementAdminPanel } from "@/components/admin/ElementAdminPanel"
import { BackgroundAdminPanel } from "@/components/admin/BackgroundAdminPanel"
    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6">
              ...
              <Tabs defaultValue="branding" className="w-full">
                ...
                <TabsContent value="colors" className="space-y-6">
                  <Card>
                    ...
                    <CardContent className="space-y-6">{/* Color Picker Component Here */}</CardContent>
                  </Card>
                </TabsContent>
                ...
                <TabsContent value="layout" className="space-y-6">
                  <Card>
                    <CardHeader>
                      <CardTitle>Layout de la Tienda</CardTitle>
                      <CardDescription>Configura el diseño de tu tienda</CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">{/* Layout Configuration Component Here */}</CardContent>
                  </Card>
                </TabsContent>
              </Tabs>
            </div>
          ...
          {activeSection === "usuarios" && <div className="space-y-6">{/* Users Management Component Here */}</div>}

          {activeSection === "analytics" && <div className="space-y-6">{/* Analytics Dashboard Component Here */}</div>}

          {activeSection === "configuracion" && (
            <div className="space-y-6">{/* Configuration Settings Component Here */}</div>
          )}
        </main>
      </div>
    </div>
