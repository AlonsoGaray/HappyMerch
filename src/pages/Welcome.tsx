...
const Welcome = () => {
  ...
  return (
    <div className="relative flex flex-col items-center text-center justify-center gap-8 bg-[#EC3B96] w-full h-dvh font-montserrat">
      <div className="flex flex-col gap-7 items-center">
        <span className="text-white text-4xl font-bold">PERSONALIZA EN VIVO, <br/> CREA SIN LÍMITES</span>
        <img className="max-w-64" src="/bcp_logo.png" alt="bcp_logo" />
