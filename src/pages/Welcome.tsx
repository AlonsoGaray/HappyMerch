...
const Welcome = () => {
  ...
  return (
    ...
    >
      ...
      <button type="button" className={`bg-[#FDA020] p-4 text-white font-bold rounded cursor-pointer text-2xl ${data.config?.welcome_button_font}`} onClick={() => navigate("/edit")}>¡MANOS A LA OBRA!</button>
